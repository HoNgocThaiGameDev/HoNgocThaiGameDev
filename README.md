<h1 align="center">Ho Ngoc Thai</h1>

<p align="center">
  Game Backend Developer focused on C#/.NET services, game systems, APIs, data persistence, and backend tooling.
</p>

<p align="center">
  <a href="https://github.com/HoNgocThaiGameDev?tab=repositories">Repositories</a>
  |
  <a href="https://github.com/HoNgocThaiGameDev?tab=repositories">Backend Projects</a>
</p>
...
![REST API](https://img.shields.io/badge/REST_API-0A66C2?style=for-the-badge&logo=fastapi&logoColor=white)
...
- Backend architecture for game features
- API design and clean service boundaries
- State persistence, save data, and migration strategy
- Database/cache usage for reliable game data
- Testing, debugging, and observable backend behavior
- Anti-cheat boundaries between client and server
